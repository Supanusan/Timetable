...
const Zoomlink = () => {
    ...
    return (
        <div>
            ...
            <ul className='py-10'>
                {findToday.links.map((link, index) => (<a id={index} href={link.link}><li className='py-6 px-6 text-3xl flex bg-slate-400 my-2 rounded-md text-white'><h1 className='underline'> {link.type} </h1><h1 className='font-semibold text-orange-600 px-4'>-{link.time}</h1></li></a>))}
